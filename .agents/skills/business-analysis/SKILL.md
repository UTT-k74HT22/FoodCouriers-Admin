...
> [!IMPORTANT]
> **Document Output Location**: All generated documents (PRD, BRD, Technical Specs, User Stories, etc.) **MUST** be saved to the `docs/` folder in the project root.
> 
> Output Structure:
> ```
> docs/
> ├── project_plans/
> │   ├── PRDs/features/[feature]-v1.md
> │   └── implementation_plans/features/[feature]-v1.md
> ├── business_analysis/
> │   ├── requirements/[feature]-requirements.md
> │   ├── use_cases/[domain]-use-cases.md
> │   ├── workflows/[process]-flow.md
