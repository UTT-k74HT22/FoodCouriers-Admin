# Tổng quan toàn hệ thống - Food Ordering System
...
- **Session Management:** Lưu trữ JWT token một cách an toàn, tự động làm mới khi hết hạn
...
- **RLS (Row Level Security)** đảm bảo Admin thấy tất cả dữ liệu, Staff chỉ thấy dữ liệu được phân công, Client chỉ thấy dữ liệu của mình
